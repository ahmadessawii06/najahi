  ...
  const groupsData = [
    {
      ...
      details:
        "مجموعة لطلاب الصف العاشر المسار الأكاديمي لتبادل الملاحظات وحل الواجبات والاستعداد للامتحانات.",
      stats: [
    ...
    },
    {
      ...
      details:
        "مجموعة واتساب مخصصة لطلاب الفرع العلمي لمناقشة التجارب العملية وحل المسائل العلمية المعقدة.",
      stats: [
    ...
    },
    {
      ...
      details:
        "قناة تيليجرام لبث الدروس المصورة وتبادل الملخصات والاختبارات التجريبية لامتحان التوجيهي.",
      stats: [
    ...
    },
    {
      ...
      details:
        "مجموعة دراسة مباشرة أسبوعية عبر Zoom لمراجعة المواد الأدبية ومناقشة القضايا الأدبية والتحليل النصي.",
      stats: [
    ...
    },
    {
      ...
      details:
        "مجموعة دراسة تفاعلية على Discord لمناقشة مسائل العلوم وحل الواجبات الأسبوعية، مع جلسات سؤال وجواب مباشرة.",
      stats: [
    ...
    },
    {
      ...
      details:
        "مجموعة فيسبوك لمناقشة مسائل الرياضيات الصعبة، شرح الدروس، ومشاركة أوراق العمل.",
      stats: [
    ...
    },
    {
      ...
      subject: "جميع المواد",
      details:
        "مجموعة ماسنجر سريعة لتبادل الواجبات اليومية والتنبيهات المهمة بين الطلاب.",
      stats: [
    ...
    },
    {
      ...
      details:
        "مجموعة واتساب لمراجعة الدروس العلمية، حل الأسئلة الوزارية، والاستعداد للامتحانات.",
      stats: [
    ...
    },
    {
      ...
      details:
        "قناة تيليجرام لنشر ملخصات الدروس، نماذج امتحانات، ونصائح دراسية يومية.",
      stats: [
    ...
    <section id="groups" className="groups-page">
      <div className="page-header">
        ...
        <p className="page-subtitle">
          انضم إلى مجموعات الدراسة عبر منصات التواصل الاجتماعي للدراسة بشكل
          تعاوني
        </p>
      </div>
            ...
            <div className="group-stats">
              {group.stats.map((stat, index) => (
                <p key={index} className="stat-item">
                  <strong className="state-big">{stat.label}</strong>{" "}
                  {stat.value}
                </p>
              ))}
            </div>

            <a href={group.link} className="join-button" target="_blank">
              {group.buttonText}
            </a>
          </div>
        ))}
