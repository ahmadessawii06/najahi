  ...
  return (
    <>
      <div className="d-page">
        <div id="donation" className="page active Donation-page">
          ...
          <div className="donation-container">
            <div className="donate-form">
              <h2
                className="h2-in-donate-form"
                style={{ marginBottom: "25px" }}
              >
                {" "}
                تواصل معنا للتبرع بمواد تعليمية{" "}
              </h2>

              <form
                id="donation-form"
                onSubmit={() => alert("شكرا لتبرعك! سيتم التواصل معك ")}
              >
                ...
                <TextField
                  ...
                  variant="outlined"
                  fullWidth
                  label="اسم المادة / اسم الكتاب"
                  id="fullWidth"
                  placeholder="كتاب رياضيات الصف الحادي عشر العلمي"
                />
            ...
            <div className="donations-grid">
              <h2
                className="h2-in-donations-grid"
                style={{ marginBottom: "25px" }}
              >
